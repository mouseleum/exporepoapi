...
6. **More adapters** — generic DIMEDIS Vis platform adapter shipped (`lib/adapters/dimedis.ts`) covering interpack, drupa, medica, glasstec, boot via thin per-show wrappers. Still pending: MYS, ExpoFP, Swapcard.
